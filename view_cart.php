...
<body>
	<img src="images/header_overlay.png" width="1345px" height="114px" />
	<img src="images/apache_pb.png"  width="350px" height="400px"/>
<div id="products-wrapper">
	<h1 style="color:gray; position:absolute;top:8px;left:280px;;">OrderAnythingOnline.com</h1>
 ...
 <div class="view-cart">
	...
	if(isset($_SESSION["products"]))
    {
		...
		echo '</span>';
		echo "<a href='details.php'>Buy Now</a>";
		echo '</form>';
