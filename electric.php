...
<body>
	...
	<ul class="nav">
    		...
    		<li><a href="food.php">Foods</a></li><li><a href="grocery.php">groceries</a></li><li><a href="electric.php" style="background-color: gray" >Electronic Items</a></li>
...
<div id="products-wrapper">
	...
	$results = $mysqli->query("SELECT * FROM services where service_type='electric'");
    if ($results) { 
