...
<body>
	...
	<ul class="nav">
    		...
    		<li><a href="food.php" style="background-color:gray;">Foods</a></li><li><a href="grocery.php">groceries</a></li><li><a href="electric.php" >Electronic Items</a></li>
...
<div id="products-wrapper">
	...
	$results = $mysqli->query("SELECT * FROM services where service_type='food'");
    if ($results) { 
